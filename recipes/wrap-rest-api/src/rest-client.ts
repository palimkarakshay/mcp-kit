/**
 * A small, hardened REST client shared by the recipe's servers.
 *
 * It is the reusable core of "wrap a REST API": one place that owns timeouts,
 * retries with backoff, JSON parsing, and — crucially — translating HTTP
 * failures into the kit's structured {@link McpToolError}s so every tool fails
